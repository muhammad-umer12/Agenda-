...
import { TextField,Paper,Button, makeStyles, Drawer } from '@material-ui/core';
 ...
 const Create = (props:any) => {
   ...
   useEffect(()=>{
    ...
    const validationSchema = yup.object({
        ...
        description: yup
        .string()
        .required('Published time is required'),
    ...
    <div>
      ...
      <Paper className={classes.innerForm} elevation={3}>
        ...
        <TextField 
             ...
             className={classes.fieldGap}
        id="time" name="time" placeholder='time' label="Date & Time" variant="outlined" fullWidth/>
        ...
        <TextField
             ...
             className={classes.fieldGap}
        id="status" name="status" label="Status" variant="outlined" fullWidth/>
